<template>
    <div>
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <inertia-link class="btn-indigo" :href="route('invoices.create')">
                <span>Create</span>
                ...
                <tr v-for="invoice in invoices.data" :key="invoice.id"
                    ...
                    <td class="border-t">
                        <inertia-link class="px-6 py-4 flex items-center focus:text-indigo-500"
                            ...
                            <icon v-if="invoice.deleted_at" name="trash"
                    ...
                    <td class="border-t w-px">
                        <inertia-link class="px-4 flex items-center" :href="route('invoices.edit', invoice.id)"
                                      tabindex="-1">
        ...
        watch: {
            form: {
                handler: throttle(function () {
                    ...
                    this.$inertia.replace(this.route('invoices', Object.keys(query).length ? query : {remember: 'forget'}))
                }, 150),
                deep: true,
            },
        },
